...
- Estado real del producto en este punto:
  ...
  - ficha y seguimiento se simplifican tras validacion en EasyPanel: fuera rail lateral redundante y fuera formularios de planes dentro de Historial,
  - `Seguimiento del caso` recibe bloqueo tipografico y jerarquia visual homogenea para evitar mezcla de estilos heredados,
