...
## Estado 2026-05-26
- `origin/main` actualizado con fixes UI responsive, Mensajes y Agenda semanal visual.
- Validado: frontend `npm.cmd run check` OK, frontend `npm.cmd run build` OK, backend `npm.cmd run lint` OK, n8n JSON OK.
- Backend local tiene cambios no relacionados sin publicar en auth/Supabase/rutas. No mezclarlos sin revisar.
